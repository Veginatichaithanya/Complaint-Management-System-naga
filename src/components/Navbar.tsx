      ...
      <AnimatePresence>
        {showAdminAuth && (
          ...
          >
            ...
            >
              <AdminSignInCard onSuccess={() => setShowAdminAuth(false)} />
              <button
                onClick={() => setShowAdminAuth(false)}
                className="absolute -top-4 -right-4 w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center text-lg font-bold transition-colors"
              >
                ×
              </button>
            </motion.div>
